<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-lg text-main-text leading-tight">ペット詳細ガイド</h2>
    </x-slot>

    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow sm:rounded-lg space-y-6">
                <p class="text-sm text-main-text">ここに送付いただくワイヤーフレームの内容を配置します。セクション構成・文言は後で差し替え可能です。</p>
