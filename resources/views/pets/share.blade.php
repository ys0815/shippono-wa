<x-guest-layout>
    ...
    <div class="min-h-screen bg-main-bg">
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <!-- ヘッダーエリア（背景/アイコン/名前） -->
            <section class="bg-white border border-main-border rounded-2xl shadow-sm overflow-hidden">
            ...
            <!-- 基本情報 -->
            <section class="mt-8 bg-white border border-main-border rounded-2xl shadow-sm p-6">
            ...
            <section class="mt-8 bg-white border border-main-border rounded-2xl shadow-sm p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        @else
                            <button disabled class="px-4 py-2 text-sm rounded-full border-2 border-main-border text-gray-400 bg-main-bg cursor-not-allowed">保護団体サイトへ</button>
                        @endif
                        ...
                        @else
                            <button disabled class="px-4 py-2 text-sm rounded-full border-2 border-main-border text-gray-400 bg-main-bg cursor-not-allowed">しっぽのわを読む</button>
                        @endif
                    </div>
                </div>
            </section>
            ...
            <!-- 関連コンテンツ（インタビュー） -->
            <section id="interview" class="mt-8 bg-white border border-main-border rounded-2xl shadow-sm p-6">
                <h2 class="text-xl font-bold text-main-text mb-4 relative inline-block">
