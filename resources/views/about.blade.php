<x-guest-layout>
    ...
    <section class="w-full relative overflow-hidden" style="position: relative !important;">
        <img src="/images/about-top.jpeg" alt="保護動物と新しい家族の幸せな日常" class="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] xl:h-[600px] object-cover">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6 sm:p-8 pb-8 sm:pb-10 pointer-events-none" style="z-index: 9999 !important; position: absolute !important; top: auto !important; bottom: 0 !important; left: 0 !important; right: 0 !important; width: 100% !important;">
            <div class="max-w-4xl mx-auto text-center">
                <p class="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-medium leading-relaxed drop-shadow-lg select-none">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- メインコンテンツ -->
        <main class="pt-8 sm:pt-12 md:pt-16 pb-16 space-y-12 sm:space-y-16 md:space-y-20">
            <!-- サイト紹介 -->
            <section class="text-center">
                <div class="max-w-4xl mx-auto">
                    ...
                    <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                        #しっぽのわとは？
                    </h1>
            ...
            <section>
                <div class="max-w-4xl mx-auto">
                    <div class="text-center" style="margin-bottom: 3rem !important;">
                        <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 block" style="margin-bottom: 1rem !important;">私たちの想い</h2>
            ...
            <section>
                <div class="max-w-5xl mx-auto">
                    <div class="text-center" style="margin-bottom: 3rem !important;">
                        <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 block" style="margin-bottom: 1rem !important;">できること</h2>
                        <div class="w-20 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mx-auto mt-2"></div>
                    </div>
                    
                    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-8">
                        <div class="space-y-8">
            ...
            <section>
                <div class="max-w-4xl mx-auto">
                    <div class="text-center" style="margin-bottom: 3rem !important;">
                        <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 block" style="margin-bottom: 1rem !important;">参加の方法</h2>
                        <div class="w-20 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mx-auto mt-2"></div>
                    </div>
                    
                    <div class="space-y-4 sm:space-y-6">
                        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 sm:p-8 border border-amber-100">
                            <div class="flex items-start space-x-4 sm:space-x-6">
                                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                    <span class="text-white text-lg font-bold">1</span>
                                </div>
                                <div class="flex-1">
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3">新規登録</h3>
                                    <p class="text-gray-600 leading-relaxed">
                        ...
                        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 sm:p-8 border border-amber-100">
                            <div class="flex items-start space-x-4 sm:space-x-6">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3">投稿・シェア</h3>
                                    <p class="text-gray-600 leading-relaxed">
                        ...
                        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 sm:p-8 border border-amber-100">
                            <div class="flex items-start space-x-4 sm:space-x-6">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-3">コミュニティ参加</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        気になるペットに「いいね」で応援し、温かいコミュニティの一員になりましょう。
                                </div>
                            </div>
            ...
            <section class="text-center">
                <div class="max-w-3xl mx-auto">
                    ...
                    <p class="text-lg sm:text-xl font-semibold text-amber-600">
                        さあ、一緒にしっぽの輪を広げましょう。
                    </p>
                </div>
            </section>
