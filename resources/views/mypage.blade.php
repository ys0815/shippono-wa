                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex space-x-2 mt-2">
                                <a href="{{ route('mypage.pets.edit', ['pet_id' => $pet->id]) }}" 
                                   class="px-3 py-1 text-white text-xs rounded transition duration-200 bg-blue-500 hover:bg-blue-600">編集</a>
                                <a href="{{ route('pets.show', $pet->id) }}" 
                                   class="px-3 py-1 text-white text-xs rounded transition duration-200 bg-amber-500 hover:bg-amber-600">詳細を見る</a>
                            </div>
                        </div>
                    </div>
                </div>
