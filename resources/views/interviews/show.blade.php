<x-guest-layout>
    ...
    <main class="max-w-4xl mx-auto">
        ...
        <div class="bg-white px-4 py-6">
            <!-- タイトル -->
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-main-text mb-4 text-center lg:text-left">
                {{ $post->title }}
            </h1>
            ...
            @if($post->interviewContent)
                ...
                @if($post->interviewContent->question1)
                        <div class="px-2">
                            <h3 class="text-lg sm:text-xl font-bold text-main-text mb-4 flex items-center">
                            ...
                            <div class="prose max-w-none text-main-text text-base sm:text-lg leading-[2.4em] bg-gradient-to-b from-[#e5e7eb] to-transparent bg-[length:100%_2.4em] bg-[position:0_1.2em] p-6 rounded-lg" style="background-image: linear-gradient(to bottom, #e5e7eb 1px, transparent 1px);">
                ...
                <!-- ペットプロフィール -->
                @if($post->pet)
                    <div class="border-t border-main-border pt-4 mt-6">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                <div class="text-xl font-bold text-main-text leading-tight">
                                    {{ e($post->pet->name) }} 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($relatedPosts as $relatedPost)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            @endif
                            <div class="p-4">
                                <h3 class="font-semibold text-main-text mb-2 line-clamp-2">{{ $relatedPost->title }}</h3>
                                <p class="text-sm text-main-text mb-3 line-clamp-3">{{ Str::limit($relatedPost->content, 100) }}</p>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 border border-main-border">
                <div class="text-center">
                    <h3 class="text-xl font-bold text-main-text mb-6">シェアしよう</h3>
